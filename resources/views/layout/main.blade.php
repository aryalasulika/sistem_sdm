...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake img-circle" src="{{ asset('lte/dist/img/logo_klinik.jpg') }}"
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="{{ route('admin.index') }}" class="brand-link">
                <img src="{{ asset('lte/dist/img/logo_klinik.jpg') }}" alt="AdminLTE Logo"
                    class="brand-image img-circle elevation-3" style="opacity: .8">
                <span class="brand-text font-weight-light">Klinik Pratama Firdaus</span>
            </a>
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.klinik') }}" class="nav-link">
        ...
        <footer class="main-footer">
            <strong>Klinik Pratama Firdaus.</strong>
        </footer>
