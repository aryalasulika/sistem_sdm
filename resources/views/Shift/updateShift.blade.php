        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <form action="{{ route('admin.updateShift', ['id' => $data_shift->id]) }}" method="POST">
                            @csrf
                            @method('PUT')
                        ...
                        <div class="card card-success">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_shift" value="{{ $data_shift->nama }}"
                                        class="form-control" placeholder="Nama Shift" required>
                                </div>
                                <div class="form-group">
                                    <label>Jam Masuk</label>
                                    <input type="time" name="jam_masuk" value="{{ $data_shift->start_time }}"
                                        class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label>Jam Keluar</label>
                                    <input type="time" name="jam_keluar" value="{{ $data_shift->end_time }}"
                                        class="form-control" required>
                                </div>
                            </div>
                            <!-- /.card-body -->
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama" class="form-control"
                                            id="exampleInputEmail1" placeholder="Masukan Nama Perusahaan">
                                        @error('nama')
                                            <small>{{ $message }}</small>
                                        @enderror
                                    </div>
